...
@WebServlet("/deleteAllForMood")
public class DeleteMoodServlets extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
                ...
                humanBeingService.deleteMood(mood);
                message.put("code", 1);
                message.put("data", "All objects have been deleted!");
            return;
